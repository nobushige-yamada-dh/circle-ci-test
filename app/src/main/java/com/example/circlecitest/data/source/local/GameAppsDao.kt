...
interface GameAppsDao {
    ...
    @Query("SELECT * FROM game_apps WHERE application_id = :applicationId AND class_name = :className")
    fun getByApplicationIdAndClassName(applicationId: String, className: String): GameApp
